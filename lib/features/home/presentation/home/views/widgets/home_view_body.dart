...
import 'package:spotify/features/home/presentation/home/views/widgets/your_created_playlists.dart';
...
class HomeViewBody extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child:  Obx(
        ()=> AbsorbPointer(
          absorbing: controller.isCreatingPlaylist.value,
          child: Stack(
            children: [
              CustomScrollView(
              ...
              if(controller.isCreatingPlaylist.value) UpdatingContainer(containerTitle: "Creating your playlist",width: MediaQuery.sizeOf(context).width*0.63657,)
            ],
          ),
        ),
      ),
